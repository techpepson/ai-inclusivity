...
export default function Disabilities() {
  ...
  const heroDescription =
    typeof focusArea?.description === "string" && focusArea.description.trim()
      ...
      : "Advocating for the rights, inclusion, and full participation of persons with disabilities in Ghanaian society. Together, we're building a more accessible and inclusive Ghana for all.";
  const heroImageSrc =
      ...
      <section className="py-20 bg-gradient-to-br from-blue-500 to-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
            Your voice matters in creating an accessible and inclusive Ghana.
