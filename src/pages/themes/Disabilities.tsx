...
export default function Disabilities() {
  const stories = [
    {
      name: "Akosua Mensah",
      story: "After losing her sight at age 25, Akosua became a powerful advocate for digital accessibility in Ghana's tech sector.",
      impact: "Led 3 major accessibility audits",
      hashtag: "#AccessibilityFirst"
    },
    {
      name: "Kwame Osei",
      story: "Born with cerebral palsy, Kwame fights for inclusive infrastructure and has influenced policy changes in Accra.",
  ...
  const keyInfluencers = [
    { name: "@GhanaDisabilityRights", followers: "125k", focus: "Policy Advocacy" },
    { name: "@AccessibleGhana", followers: "89k", focus: "Infrastructure" },
    { name: "@InclusiveTechGH", followers: "67k", focus: "Digital Accessibility" },
  ...
  const resources = [
    {
      ...
      description: "National umbrella organization representing 17 disability groups",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <Card className="bg-gradient-card border-0 text-center">
            <CardContent className="pt-6">
              <div className="text-3xl font-bold text-theme-disability mb-2">3.2M</div>
              <p className="text-sm text-muted-foreground">PwDs in Ghana</p>
            </CardContent>
          </Card>
          <Card className="bg-gradient-card border-0 text-center">
            <CardContent className="pt-6">
              <div className="text-3xl font-bold text-theme-disability mb-2">15%</div>
              <p className="text-sm text-muted-foreground">of Population</p>
            </CardContent>
          </Card>
          <Card className="bg-gradient-card border-0 text-center">
            <CardContent className="pt-6">
              <div className="text-3xl font-bold text-theme-disability mb-2">125k</div>
              <p className="text-sm text-muted-foreground">Social Mentions</p>
            </CardContent>
          </Card>
          <Card className="bg-gradient-card border-0 text-center">
            <CardContent className="pt-6">
              <div className="text-3xl font-bold text-theme-disability mb-2">89%</div>
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              The most active hashtags driving disability rights discussions in Ghana.
            </p>
          </div>
              ...
              <Card key={index} className="bg-gradient-card border-0">
                <CardContent className="pt-6">
                  <div className="text-center space-y-2">
                    <div className="text-lg font-mono text-theme-disability">{hashtag.tag}</div>
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Real stories from persons with disabilities making a difference in Ghana.
            </p>
          </div>
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Influential advocates and organizations leading the disability rights movement.
            </p>
          </div>
            ...
            {keyInfluencers.map((influencer, index) => (
              <Card key={index} className="bg-gradient-card border-0">
                <CardContent className="pt-6 text-center space-y-3">
                  ...
                  <div>
                    <div className="font-semibold text-theme-disability">{influencer.name}</div>
        ...
        <section>
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Connect with organizations providing support and advocacy for persons with disabilities.
            </p>
          </div>
