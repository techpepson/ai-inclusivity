  ...
  const campaigns = [
    {
      ...
      description: "National campaign promoting mental health awareness and reducing stigma"
    },
    {
      name: "#MentalHealthAwareness",
      reach: "2.4M people",
      engagement: "98k interactions",
      description: "Educational initiative sharing mental health resources and stories"
    },
    {
      name: "#WellnessMatters",
      reach: "1.9M people",
      engagement: "76k interactions", 
      description: "Holistic wellness campaign focusing on mental, physical, and social health"
    }
  ];

  const keyInfluencers = [
    { name: "@MentalHealthGH", followers: "87k", focus: "Education & Awareness" },
  ...
  const supportServices = [
    {
      ...
      description: "National authority providing mental health policy and coordination",
      services: ["Policy Development", "Training", "Public Education", "Advocacy"],
      hotline: "+233-302-234-567",
      email: "info@mentalhealth.gov.gh"
    },
    {
      name: "Mindcare Ghana",
      description: "NGO providing accessible mental health support and counseling",
      services: ["Counseling", "Support Groups", "Crisis Intervention", "Referrals"],
    ...
    },
    {
      ...
      services: ["Crisis Support", "Emotional Support", "Information", "Referrals"],
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <Card className="bg-gradient-card border-0 text-center">
            <CardContent className="pt-6">
              <div className="text-3xl font-bold text-theme-mental mb-2">1 in 4</div>
              <p className="text-sm text-muted-foreground">People affected annually</p>
            </CardContent>
          </Card>
          <Card className="bg-gradient-card border-0 text-center">
            <CardContent className="pt-6">
              <div className="text-3xl font-bold text-theme-mental mb-2">98k</div>
              <p className="text-sm text-muted-foreground">Social Mentions</p>
            </CardContent>
          </Card>
          <Card className="bg-gradient-card border-0 text-center">
            <CardContent className="pt-6">
              <div className="text-3xl font-bold text-theme-mental mb-2">24/7</div>
              <p className="text-sm text-muted-foreground">Crisis Support</p>
            </CardContent>
          </Card>
          <Card className="bg-gradient-card border-0 text-center">
            <CardContent className="pt-6">
              <div className="text-3xl font-bold text-theme-mental mb-2">92%</div>
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-4">Understanding Mental Health</h2>
            <p className="text-lg text-muted-foreground">
              Important facts everyone should know about mental health and wellness.
            </p>
          </div>
              ...
              <Card key={index} className="bg-gradient-card border-0">
                <CardContent className="pt-6">
                  <div className="text-center space-y-2">
                    <div className="text-lg font-mono text-theme-mental">{hashtag.tag}</div>
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-4">Active Awareness Campaigns</h2>
            <p className="text-lg text-muted-foreground">
              Supporting mental health through education, advocacy, and community building.
            </p>
          </div>
              ...
              <Card key={index} className="bg-gradient-card border-0">
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <div className="font-semibold text-theme-mental">{campaign.reach}</div>
                      <div className="text-muted-foreground">Reach</div>
                    </div>
                    <div>
                      <div className="font-semibold text-theme-mental">{campaign.engagement}</div>
            ...
            {keyInfluencers.map((influencer, index) => (
              <Card key={index} className="bg-gradient-card border-0">
                <CardContent className="pt-6 text-center space-y-3">
                  ...
                  <div>
                    <div className="font-semibold text-theme-mental">{influencer.name}</div>
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-4">Mental Health Support Services</h2>
            <p className="text-lg text-muted-foreground">
              Professional help and support are available. You don't have to face this alone.
            </p>
          </div>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="font-semibold text-theme-mental">{service.hotline}</span>
                    </div>
        ...
        <section>
          <Card className="bg-gradient-accent text-white border-0">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl">Your Mental Health Matters</CardTitle>
            ...
            <CardContent className="text-center">
              <div className="space-y-4">
                <div className="text-xl font-semibold">Crisis Support: 18555 (Toll-free)</div>
