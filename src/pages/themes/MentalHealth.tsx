...
export default function MentalHealth() {
  ...
  const stories = [
    {
      name: "Kweku Asante",
      story:
        "After struggling with depression, Kweku now leads peer support groups that have helped hundreds of young Ghanaians open up about their mental health.",
      impact: "500+ people supported",
      hashtag: "#BreakTheStigma",
    },
    {
      name: "Ama Darko",
      story:
        "A clinical psychologist who created Ghana's first online mental health resource hub, making information accessible to all.",
      impact: "100k+ resources accessed",
      hashtag: "#MentalHealthGH",
    },
  ];
  ...
  const trendingHashtags = [
    { tag: "#MentalHealthGH", tweets: "38.5k", sentiment: "84%" },
    { tag: "#BreakTheStigma", tweets: "27.3k", sentiment: "91%" },
    { tag: "#WellnessMatters", tweets: "21.8k", sentiment: "88%" },
    { tag: "#MentalWellness", tweets: "15.2k", sentiment: "92%" },
  ];
  ...
  const resources = [
    {
      ...
      description:
        "National body coordinating mental health services across Ghana",
      contact: "info@mentalhealth.gov.gh",
      services: ["Policy", "Standards", "Training"],
    },
    {
      title: "Mindcare Ghana",
      description: "Providing accessible mental health services and support",
      contact: "support@mindcare.gh",
      services: ["Counseling", "Therapy", "Crisis Support"],
    },
    {
      title: "Mental Health Crisis Helpline",
      description: "24/7 crisis support for those in need",
      contact: "18555 (Toll-free)",
      services: ["Crisis Support", "Referrals", "Emotional Support"],
    },
  ];
  ...
  const heroDescription =
    typeof focusArea?.description === "string" && focusArea.description.trim()
      ...
      : "Breaking the stigma around mental health in Ghana. Together, we're creating a society where seeking help is normalized and mental wellness is prioritized.";
  const heroImageSrc =
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10 py-20 text-white">
          ...
          >
            ...
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
              ...
              <span className="font-bold">102k</span>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              The most active hashtags driving mental health discussions in
              Ghana
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Real stories from mental health advocates making a difference in
              Ghana
            </p>
          </div>
              ...
              >
                <CardContent className="p-8">
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-teal-500 to-emerald-500 rounded-full flex items-center justify-center text-white font-bold text-lg shrink-0">
                      {story.name.charAt(0)}
                    </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Influential advocates and organizations leading mental health
              awareness
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {keyVoices.map((influencer, index) => (
              ...
              >
                <CardContent className="pt-8 pb-6 text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-teal-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Connect with organizations providing mental health support
              services
            </p>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-teal-500 to-emerald-500 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">
            Join the Movement for Mental Wellness
          </h2>
          <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
            Your voice matters in breaking the stigma. Join thousands of
            advocates making mental health a priority.
          </p>
