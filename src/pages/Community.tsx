...
import { MessageCircle, Users, Mail, Send, ExternalLink, Hash } from "lucide-react";
...
export default function Community() {
  ...
  const socialChannels = [
    { platform: "Twitter", handle: "@AI4InclusiveGh", followers: "45.2k", description: "Daily updates and campaign highlights" },
    { platform: "Facebook", handle: "AI4InclusiveGhana", followers: "38.7k", description: "Community discussions and events" },
    { platform: "LinkedIn", handle: "AI4Inclusive Ghana", followers: "22.1k", description: "Professional networking and policy updates" },
    { platform: "Instagram", handle: "@ai4inclusivegh", followers: "31.5k", description: "Stories and visual advocacy content" }
  ];
    ...
    <div className="min-h-screen py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-5xl font-bold mb-6">Community & Connect</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Join our vibrant community of advocates, share experiences, learn from others, 
            and collaborate on building a more inclusive Ghana.
          </p>
        </div>
                ...
                <CardHeader>
                  <div className="flex flex-col lg:flex-row lg:items-start justify-between space-y-4 lg:space-y-0">
                    <div className="flex-1">
                      ...
                      <CardDescription className="mb-3">{discussion.excerpt}</CardDescription>
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Don't miss these opportunities to connect and learn with our community.
            </p>
          </div>
          ...
          <Card className="bg-gradient-hero text-white border-0">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-white/90 text-lg">
                Get weekly updates on advocacy campaigns, community discussions, and upcoming events.
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <Card key={index} className="bg-gradient-card border-0 text-center">
                <CardContent className="pt-6 space-y-4">
                  <div className="space-y-2">
                    <h4 className="font-semibold text-lg">{channel.platform}</h4>
                    <p className="text-sm text-primary font-mono">{channel.handle}</p>
